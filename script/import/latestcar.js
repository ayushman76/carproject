...
for(var i in Hatchback_arr){
      document.querySelector('.hatchback>.crouselitem01>.product').innerHTML+=`
...
for(var i in saden_arr){
      document.querySelector('.saden>.crouselitem01>.product').innerHTML+=`
...
for(var i in suv_arr){
      document.querySelector('.suv>.crouselitem01>.product').innerHTML+=`
...
for(var i in muv_arr){
      document.querySelector('.muv>.crouselitem01>.product').innerHTML+=`
...
for(var i in luxury_arr){
      document.querySelector('.luxury>.crouselitem01>.product').innerHTML+=`
